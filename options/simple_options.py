...
class SimpleOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--planes', required=True, default=2, help='number of planes to train simple')
        ...
        parser.add_argument('--ndf_sag', type=int, default=64, help='# of discrim filters in the first conv layer')
        ...
        parser.add_argument('--netD_sag', type=str, default='n_layers', help='specify discriminator architecture [basic | n_layers | pixel]. The basic model is a 70x70 PatchGAN. n_layers allows you to specify the layers in the discriminator')
        ...
        parser.add_argument('--n_layers_D_sag', type=int, default=3, help='only used if netD==n_layers')
